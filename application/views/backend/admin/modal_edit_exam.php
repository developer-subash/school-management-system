<?php 
$edit_data		=	$this->db->get_where('exam' , array('exam_id' => $param2) )->result_array(); exit();
		...
		<div class="panel panel-primary" data-collapsed="0">
            ...
            <div class="padded">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="start_date" value="<?php echo $row['start_date'];?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="end_date" value="<?php echo $row['end_date'];?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="mark_distribution" value="<?php echo $row['mark_distribution'];?>" data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>"/>
                    </div>
                </div>
