    ...
    <li class="<?php if ($page_name == 'parent') echo 'active'; ?> ">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'assign_student_section') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/update_student_section">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('Update_student_section'); ?></span>
                    </a>
                </li>

                <!-- Assign Student Roll no -->

                <li class="<?php if ($page_name == 'update_rollno') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/update_rollno">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('update_rollno'); ?></span>
                    </a>
                </li>                 
   ...
   <li class="<?php if ($page_name == 'teacher') echo 'active'; ?> ">
        ...
        ?> ">
            ...
            <ul>
                ...
                <li class="<?php if ($page_name == 'subject_credit') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/subject_credit">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('subject_credit'); ?></span>
                    </a>
                </li>

                <li class="<?php if ($page_name == 'grade_marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/grade_marks">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('grade_scale'); ?></span>
                    </a>
                </li>


                <li class="<?php if ($page_name == 'routine') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/routine">
                ...
                <li class="<?php if ($page_name == 'set_term_marks') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/set_term_marks">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('set_term_marks'); ?></span>
                    </a>
                </li>

                <li class="<?php if ($page_name == 'filter_case') echo 'active'; ?> ">
                    <a href="<?php echo base_url(); ?>index.php?admin/select_case">
                        <span><i class="entypo-dot"></i> <?php echo get_phrase('select_case_requirement'); ?></span>
                    </a>
                </li>
