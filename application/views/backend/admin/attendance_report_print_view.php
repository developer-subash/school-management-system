...
<div id="print">
    ...
    for ($i = 1; $i <= $days; $i++) {
        ?>
            ...
            <?php if ($status == 1) { $count=$count+1; $countP++;?>
                                    <div style="color: #00a651">P</div>
                            <?php } else if ($status == 2) { $count=$count+1; ?>
        ...
        <td style="text-align: center;"><?php echo $countP; ?></td>
        <td style="text-align: center;"><?php echo round($countP*100/$count); ?></td>
