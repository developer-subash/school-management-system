                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="payumoney_merchant_key"
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'payumoney_merchant_key'))->row()->description;?>" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="payumoney_salt_id"
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'payumoney_salt_id'))->row()->description;?>" required>
                      </div>
                  </div>
      ...
      ?>
        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                This is the general setting page here you can manage School and System details. You can also upload your school logo. Only available for Admin Login.
                </div>
