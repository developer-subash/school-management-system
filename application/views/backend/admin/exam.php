                ...
                <table  class="table table-bordered datatable" id="table_export">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td><?php echo $row['mark_distribution'];?></td>
							<td>
                            <div class="btn-group">
                ...
                <div class="box-content">
                	<?php echo form_open(base_url() . 'index.php?admin/exam/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="start_date" placeholder="<?php echo get_phrase('start_date'); ?>"  data-validate="required" data-message-required="<?php echo get_phrase('value_required');?>" placeholder="Enter start date of exam"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('end_date');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="datepicker form-control" name="end_date" placeholder="<?php echo get_phrase('end_date'); ?>" data-validate="required" placeholder="Enter end date of exam" data-message-required="<?php echo get_phrase('value_required');?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label"><?php echo get_phrase('comment');?></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" placeholder="<?php echo get_phrase('comment'); ?>" name="comment" placeholder="Comment" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" placeholder="<?php echo get_phrase('mark_distribution'); ?>" name="mark_distribution" placeholder="Enter marks for exam" />
                                </div>
                            </div>
