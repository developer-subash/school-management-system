		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/student/do_update/'.$row['student_id'].'/'.$row['class_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="roll"
								value="<?php echo $row['roll'];?>">
										...
										<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('joinig_date');?></label>
                        
						<div class="col-sm-5">
							<input type="text" class="form-control datepicker" name="joining_date" 
								value="<?php echo $this->db->get_where('enroll' , array('student_id' => $row['student_id']))->row()->joining_date; ?>" 
									data-start-view="2">
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="current_address" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->current_address; ?>" >
						</div> 
					</div>
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" name="permanent_address" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->permanent_address; ?>" >
						</div> 
					</div>
					...
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('disability');?></label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="disability" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->disability; ?>">
						</div>
					</div>
					<div class="form-group">
						<label for="field-1" class="col-sm-3 control-label"><?php echo get_phrase('known_allergy');?></label>
						<div class="col-sm-5">
							<input type="text" class="form-control" name="known_allergy" 
								value="<?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->known_allergy; ?>">
						</div>
					</div>
					<div class="form-group">
