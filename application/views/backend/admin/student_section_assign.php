			...
			<ul class="profile-info-sections">
				<li style="padding:0px; margin:0px;">
					<div class="profile-name">
							<h3>
                                <?php echo $this->db->get_where('student' , array('student_id' => $param3))->row()->name;?>                     
                            </h3>
					</div>
				</li>
			</ul>
			...
			<div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td><?php echo get_phrase('joining_date');?></td>
                        <td><b><?php echo $row['joining_date'];?></b></td>
                    </tr>
                    <?php endif;?>
                    <tr>
                    ...
                    <tr>
                        <td><?php echo get_phrase('current_address');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->current_address;?></b>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->blood_group;?></b>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo get_phrase('mother_tongue');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->mother_tongue;?></b>
                        </td>
                    </tr>
                    <tr>
                        <td><?php echo get_phrase('cast_category');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->cast_category;?></b>
                        </td>
                    </tr>
                     <tr>
                        <td><?php echo get_phrase('religion');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->religion;?></b>
                        </td>
                    </tr>
                     <tr>
                        <td><?php echo get_phrase('disability');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->disability;?></b>
                        </td>
                    </tr>
                     <tr>
                        <td><?php echo get_phrase('known_allergy');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->known_allergy;?></b>
                        </td>
                    </tr>

                     <tr>
                        <td><?php echo get_phrase('permanent_address');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->permanent_address;?></b>
                        </td>
                    </tr>
                     <tr>
                        <td><?php echo get_phrase('phone');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->phone;?></b>
                        </td>
                    </tr>
                    <tr>
